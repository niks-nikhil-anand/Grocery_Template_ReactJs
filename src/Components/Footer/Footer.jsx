        ...
        <footer id='footer' className='text-white' style={{ backgroundColor: '#123F1E' }}>
            ...
            <div>
                ...
                <div className='text-center flex items-center h-12'>
                    <span className='text-xs  w-full block text-gray-300 tracking-wider'>© 2024 Developed By 2Solution <a className='hover:underline' href="https://2solution.in" target="_blank" rel="noopener noreferrer"> 2Solution </a></span>
                </div>
            </div>
        </footer>
    );
